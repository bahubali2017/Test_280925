...
/**
 * QA Helper function return types (imported from medical AI modules)
 */

/**
 * @typedef {object} TriageEvaluationResult
...
/**
 * @typedef {object} GeneratedEvaluationReport
...
/**
 * @typedef {object} FeedbackValidationResult
 * @property {boolean} isValid - Whether validation passed
 * @property {string[]} errors - Validation error messages
 */

/**
 * @typedef {object} AnalyzedFeedbackTrends
...
/**
 * Async test runner for medical AI QA framework
 * Wraps all async operations to satisfy TypeScript strict mode
...
// Execute the QA test suite
void runQATestSuite().catch((error) => {
